...
### 🔄 В работе сейчас:
Проверка и тестирование всех реализованных функций

### 📌 Следующий шаг:
1. **Деплой на Vercel** — выложить в интернет, добавить DEEPSEEK_API_KEY в env
2. **Поделиться ссылкой** — /kp/abc123, КП живёт 7 дней (нужна БД или Vercel KV)
3. **PDF через @react-pdf/renderer** — настоящий PDF вместо печати браузера
4. **Экспорт в Word** — библиотека docx
5. **NextAuth + лимит 3 КП** — авторизация и монетизация
