...
- [x] **[F07] Онбординг** — предзаполненная форма с примером при первом посещении (localStorage флаг)

### 🔄 В работе сейчас:
Спринт 2 — удержание: [F06] История КП в БД, [F05] триггеры, [F02] годовая подписка

### 📌 Следующий шаг (по скиллу kp-generator):
**Спринт 2:**
1. **[F06]** Личный кабинет с историей и статусами КП
2. **[F05]** Триггерные уведомления (email/TG при неактивности)
3. **[F02]** Годовая подписка 7 990 ₽
4. **[F01]** Тариф «Разово» 199 ₽
